...
let zhTranslations = {
    ...
    'enable_unclassified_under_settings': '启用未分类Cookie（在应用Cookie设置菜单下）',
    'open_website_and_navigate': '用浏览器打开目标网站，浏览可能设置Cookie的页面',
    'refresh_cookies': '点击上方刷新按钮，设置的Cookie会在表格列出',
