...
let zhTranslations = {
    ...
    'check_dns_to_primary_node': '步骤1：用户侧，请确保域名指向网关的主节点',
    'open_website': '步骤2：用户侧，用浏览器打开目标网站，如果没有出现Cookie偏好设置窗口，请点击窗口左下角的Cookie图标',
    'enable_unclassified_and_navigate': '步骤3：用户侧，需要一个或多个团队成员，在Cookie偏好设置窗口，启用未分类Cookie并确认，然后浏览可能设置Cookie的页面',
    'refresh_cookies': '步骤4：网关侧，点击上方刷新按钮，查看识别出的Cookie清单',
    'modify_cookie_type': '步骤5：网关侧，检查或修改每一Cookie类型，直至未分类Cookie数量清零',
    'disable_unclassified': '步骤6：用户侧，如果未分类Cookie已清零，在Cookie偏好设置窗口禁用未分类Cookie',
    'navigate_website': '步骤7：用户侧，浏览目标网站，检查Cookie设置是否生效',
    // CookieRef
